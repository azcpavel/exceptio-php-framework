...
*            );
*        
*        $test = Zend_Barcode::factory('ean13', 'image', $barOpt, $barRen)->draw();
*        //Zend_Barcode::factory('ean13', 'image', $barOpt, $barRen)->render();
*        // Make the background transparent
*        // $white = imagecolorallocate($test, 255, 255, 255);
*        // imagecolortransparent($test, $white);
*        
*        
*        // var_dump($test);
*        imagepng($test, 'barcode.png', 9);
*/
class Zend_Barcode
{
    /**
